        ...
        return (
          <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-end">
            <a
              ...
              title={isGithub ? "View GitHub Repository" : "Visit Website"}
              className="text-gray-400 hover:text-gray-900 transition-colors p-1 flex items-center gap-1.5 text-sm font-medium"
            >
              {isGithub ? (
                <svg
                  className="w-5 h-5"
